#!/bin/bash
#SBATCH --job-name=ETR-BASE
#SBATCH --output=logs/trzsl_eurosat_base_split_3.out
#SBATCH --ntasks=1
...
for model in textual_prompt visual_prompts multimodal_prompt; do # coop_baseline
