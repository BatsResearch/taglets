#!/bin/bash
#SBATCH --job-name=2-ATR-mGRIP
#SBATCH --output=logs/trzsl_fgvca_multi_grip_2.out
#SBATCH --ntasks=1
...
for dataset_dir in '/users/resfandi/data/bats/datasets/classification' ; do
...
for optim_seed in 2; do # 2 3 4 5; do #10 100 50 400 250; do
