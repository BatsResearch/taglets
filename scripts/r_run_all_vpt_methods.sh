#!/bin/bash
#SBATCH --job-name=R-all_pseudo_meth
#SBATCH --output=logs/resiscs45_all_pseudo_methods.out
#SBATCH --ntasks=1
...
for model in all_vpt_pseudo_baseline all_labeles_vpt_pseudo; do #coop_pseudo_baseline vpt_pseudo_baseline; do #  all_vpt_pseudo_baseline; do 
