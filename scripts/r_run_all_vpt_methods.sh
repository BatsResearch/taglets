...
#SBATCH --output=logs/resiscs45_all_pseudo_methods_split_500.out
#SBATCH --ntasks=1
...
for model in all_vpt_pseudo_baseline; do #coop_pseudo_baseline vpt_pseudo_baseline; do #  all_vpt_pseudo_baseline; do 
