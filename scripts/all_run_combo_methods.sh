#!/bin/bash
#SBATCH --job-name=all-combo_meth
#SBATCH --output=logs/all_combo_methods_split_500.out
#SBATCH --ntasks=1
...
for model in combo_vpt_baseline after_combo_vpt_baseline post_vpt_baseline; do #  all_vpt_pseudo_baseline; do 
