#!/bin/bash
#SBATCH --job-name=R-regular_meth
#SBATCH --output=logs/resics_regularizer_methods_split_500.out
#SBATCH --ntasks=1
...
for model in regularizer_vpt_baseline; do #  all_vpt_pseudo_baseline; do 
