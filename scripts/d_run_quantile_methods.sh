#!/bin/bash
#SBATCH --job-name=D-quantile_meth
#SBATCH --output=logs/dtd_quantile.out
#SBATCH --ntasks=1
...
for model in quantile_coop_pseudo_baseline quantile_vpt_pseudo_baseline; do # coop_pseudo_baseline
