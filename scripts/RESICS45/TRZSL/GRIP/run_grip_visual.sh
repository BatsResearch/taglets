#!/bin/bash
#SBATCH --job-name=RTR-vGRIP
#SBATCH --output=logs/trzsl_resics_image_grip_vit.out
#SBATCH --ntasks=1
...
for model in grip_visual; do # coop_baseline
for optim_seed in 1 2 3 4 ; do # 2 3 4 5; do #10 100 50 400 250; do
