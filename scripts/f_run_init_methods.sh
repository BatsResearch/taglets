#!/bin/bash
#SBATCH --job-name=F-init_meth
#SBATCH --output=logs/flowers102_init_methods_split_500.out
#SBATCH --ntasks=1
...
for model in mix_vpt_baseline combo_vpt_baseline; do #  all_vpt_pseudo_baseline; do 
