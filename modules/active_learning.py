...
class RandomActiveLearning(ActiveLearningModule):
    ...
    def find_candidates(self, available_budget, unlabeled_images_names):
        """
        ...
        to_request = sample(unlabeled_images_names, min(len(unlabeled_images_names), available_budget))
