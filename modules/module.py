...
class Module:
    ...
    def train_taglets(self, train_data_loader, val_data_loader, test_data_loader, use_gpu):
        """
        ...
        for taglet in self.taglets:
            taglet.train(train_data_loader, val_data_loader, test_data_loader, use_gpu)
