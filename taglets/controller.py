...
class Controller:
    ...
    """
    def __init__(self, task, simple_run=False, checkpoint_num=None):
        self.task = task
        self.end_model = None
        self.unlabeled_vote_matrix = None
        self.val_vote_matrix = None
        self.simple_run = simple_run
        self.num_checkpoint = checkpoint_num
    ...
    def train_end_model(self):
        ...
        self.end_model.train(end_model_train_data, val, num_checkpoint=self.num_checkpoint)
