...
class Taglet:
    ...
    def _train_epoch(self):
        ...
        epoch_acc = running_acc.double() / len(self.train_data_loader.dataset)
    ...
    def _validate_epoch(self, data_loader):
        ...
        epoch_acc = running_acc.double() / len(data_loader.dataset)
    ...
    def load_data(self):
        ...
        train_val_test_data = CustomDataSet(self.task.unlabeled_image_path, image_names, image_labels, transform,
        ...
        train_data_loader = torch.utils.data.DataLoader(train_set, batch_size=self.batch_size, shuffle=False,
                                                            num_workers=self.num_workers)
        val_data_loader = torch.utils.data.DataLoader(val_set, batch_size=self.batch_size, shuffle=False,
                                                        num_workers=self.num_workers)
        test_data_loader = torch.utils.data.DataLoader(test_set, batch_size=self.batch_size, shuffle=False,
                                                            num_workers=self.num_workers)
